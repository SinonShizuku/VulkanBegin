...
void CreatePipeline(VkExtent2D canvasSize) {
	//Offscreen
	static shaderModule vert_offscreen((rootDir / "shader/Line.vert.spv").c_str());
	static shaderModule frag_offscreen((rootDir / "shader/Line.frag.spv").c_str());
	...
	//Screen
	static shaderModule vert_screen((rootDir / "shader/CanvasToScreen.vert.spv").c_str());
	static shaderModule frag_screen((rootDir / "shader/CanvasToScreen.frag.spv").c_str());
